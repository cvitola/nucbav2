...
function escribirHtml(){
     const nuevoArray = listaClientes.map(
      ...
      listarClientes.innerHTML = `<li> <div class="item-titulo">CLAVE</div> <div class="item-titulo">DNI</div> <div class="item-titulo">NOMBRES</div> <div class="item-titulo">U$S</div> <div class="item-titulo">Acción</div> </li>` + nuevoArrayJoineado;
}